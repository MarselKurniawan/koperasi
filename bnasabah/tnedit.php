...
$sql = "SELECT * FROM tnasabah WHERE id=$id";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../bukuharian/bharian.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Buku Harian</a>
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="protnedit.php" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="Nama" name="nm" value="<?php echo $data['nm'];?>">
                                <label for="floatingPassword">Nama</label>
                            </div>
                            <div class="form-floating mb-3 ">
                                <?php $ktp = $data['ktp'];?>
                                <select class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example" name="ktp">
                                    <option <?php echo ( $ktp == 'Terima')? "selected":"";?>>Terima</option>
                                    <option <?php echo ( $ktp == 'Belum Terima')? "selected":"";?>>Belum Terima</option>
                                </select>
                                <label for="floatingSelect">Status KTP</label>
                            </div>
                            <div class="form-floating mb-3 ">
                                <?php $kk = $data['kk'];?>
                                <select class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example" name="kk">
                                    <option <?php echo ( $kk == 'Terima')? "selected":"";?>>Terima</option>
                                    <option <?php echo ( $kk == 'Belum Terima')? "selected":"";?>>Belum Terima</option>
                                </select>
                                <label for="floatingSelect">Status Kartu Keluarga</label>
                            </div>
                            <div class="form-floating mb-3 ">
                                <?php $status = $data['status'];?>
                                <select class="form-select" id="floatingSelect"
                                    aria-label="Floating label select example" name="status">
                                    <option <?php echo ( $status == 'Acc')? "selected":"";?>>Acc</option>
                                    <option <?php echo ( $status == 'No Acc')? "selected":"";?>>No Acc</option>
                                </select>
                                <label for="floatingSelect">Status</label>
                            </div>
                            <div class="form-floating">
                                <button type="submit" name="edit" class="btn btn-primary" >Tambah</button>
                                <a href="bnasabah.php"><button type="button" name="submit" class="btn btn-warning" >Kembali</button></a>
                            </div>
                        </form>
                    </div>
                </div>
