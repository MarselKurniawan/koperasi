                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="jumat.php" class="dropdown-item">Jumat</a>
                        </div>
                    </div>
                </div>
            </nav>
        ...
        <div class="content">
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Tambah Data Hari Jumat</h6>
                        <form action="protajumat.php" method="POST">
                            ...
                            <div class="form-floating">
                                ...
                                <a href="jumat.php"><button type="button" name="submit" class="btn btn-warning" >Kembali</button></a>
                            </div>
                        </form>
                    </div>
                </div>
