        ...
        <div class="content">
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Tambah Data Hari Rabu</h6>
                        <form action="protarabu.php" method="POST">
                            ...
                            <div class="form-floating">
                                ...
                                <a href="rabu.php"><button type="button" name="submit" class="btn btn-warning" >Kembali</button></a>
                            </div>
                        </form>
                    </div>
                </div>
