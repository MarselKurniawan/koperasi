...
include "../../config.php";
if(!isset($_GET['id'])){
    header('Location:kamis.php?SuksesMendapatId');
}
$id = $_GET['id'];

$sql = "SELECT * FROM tkamis WHERE id=$id";
        ...
        <div class="content">
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Edit Hari Kamis</h6>
                        <form action="proeditkamis.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $data['id'];?>">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="floatingPassword"
                                    placeholder="Tanggal" name="tgl" value="<?php echo $data['tgl'];?>">
