                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="kamis.php" class="dropdown-item">Kamis</a>
        ...
        <div class="content">
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        <h6 class="mb-4">Tambah Data Hari Kamis</h6>
                        <form action="protakamis.php" method="POST">
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="floatingPassword"
                                    placeholder="Nama" name="tgl">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="floatingPassword"
                                    placeholder="Nama" name="penerima">
                                <label for="floatingPassword">Penerima</label>
                            </div>
                            <div class="form-floating">
                                <button type="submit" name="submit" class="btn btn-primary" >Tambah</button>
                                <a href="kamis.php"><button type="button" name="submit" class="btn btn-warning" >Kembali</button></a>
                            </div>
                        </form>
                    </div>
                </div>
