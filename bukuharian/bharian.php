                        ...
                        <table class="table table-striped data" id="data">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="bhedit.php?id=<?php echo $data['id']?>"><img width=80% src="../img/edit.png" alt=""></a>  
                                    </td>
                                    <td>|</td>
                                    <td>
                                    <a href="bhhapus.php?id=<?php echo $data['id']?>"><img width=80% src="../img/hapus.png" alt=""></a>
                                    </td>
                                </tr>
                                <?php
                                }
