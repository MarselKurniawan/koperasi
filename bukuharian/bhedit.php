...
$sql = "SELECT * FROM bharian WHERE id=$id";
            ...
            <div class="col-12 container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <div class="bg-secondary rounded h-100 p-4">
                        ...
                        <form action="probhedit.php" method="POST">
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" name="tgl" id="floatingInput" class="form-control" value="<?php echo $data['tgl'];?>">
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword"
                                    placeholder="Masuk" name="masuk" value="<?php echo $data['masuk'];?>">
                                <label for="floatingPassword">Masuk</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword"
                                    placeholder="Keluar" name="keluar" value="<?php echo $data['keluar'];?>">
                                <label for="floatingPassword">Keluar</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" placeholder="Leave a comment here"
                                    id="floatingTextarea" style="height: 150px;" name="ket" value="<?php echo $data['ket'];?>"></input>
                                <label for="floatingTextarea">Keterangan</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="number" class="form-control" id="floatingPassword"
                                    placeholder="Sisa" name="sisa" value="<?php echo $data['sisa'];?>">
                            ...
                            <div class="form-floating mb-3 ">
                                <select class="form-select" id="floatingSelect"
                                    ...
                                    <?php $ttd = $_POST['ttd'];?>
                                    <option <?php ($ttd == 'Marsel') ? "Selected": ""?>>Marsel</option>
                                    <option <?php ($ttd == 'Marsel') ? "Selected": ""?>>Ridho</option>
                                </select>
